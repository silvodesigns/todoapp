...
@app.route('/lists/<lists_id>', methods=['POST'])
def create_todo(lists_id):
    error = False
    body ={}
    try:
        description = request.get_json()['description']
        todo = Todo(description=description, list_id=lists_id)
        db.session.add(todo)
        db.session.commit()
...
@app.route('/lists/createlistitem', methods=['POST'])
def create_list():
    error = False
    body ={}
    try:
